...
public class AmadeusAPITest extends BaseTest {
    ...
    public void flightAPISetup(String baseURI,String grantType,String clientId,String clientSecret){
        ...
        accessToken = restClient.getAccessToken(APIConstants.getAmadeusTokenEndpoint(),grantType, clientId, clientSecret);
    }
    ...
    public void getFlightInfoTest(){
        ...
        Response flightDataResponse =getRestClientFlight.get(APIConstants.getAmadeusFlightbookingEndpoint(),headersMap,queryParams,true,false)
                .then().log().all()
                .assertThat()
